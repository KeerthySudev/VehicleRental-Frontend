          ...
          {data.getAllVehicles.map((vehicle: Vehicle) => (
            <div key={vehicle.id} className={styles.card}>
              ...
              <div className={styles.buttons}>
                ...
                <button onClick={() => handleDelete(vehicle.id)} className={styles.delete}>
                  <FontAwesomeIcon icon={faTrash} />
                </button>
                <button className={styles.info}>
                  <FontAwesomeIcon icon={faEye} />
                </button>
                {vehicle.isRentable? (<button onClick={() => handleRentable(vehicle.id)} className={styles.check}>
                  <FontAwesomeIcon icon={faCheckCircle} />
                </button>) : (<button onClick={() => handleRentable(vehicle.id)} className={styles.cross}>
